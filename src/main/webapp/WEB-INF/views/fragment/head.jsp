...
<html>
   ...
   <!--  calendar 관련 resources-->
    ...
    <link href="<c:url value='/calendar/fullcalendar/packages/core/main.css'/>" rel="stylesheet" />
    <link href= "<c:url value='calendar/fullcalendar/packages/daygrid/main.css'/>" rel="stylesheet" />
