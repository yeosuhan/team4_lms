...
<html>
    ...
    <script src="/cd/js/popper.min.js"></script>
    <script src="/cd/js/bootstrap.min.js"></script>

    <script src='/cd/fullcalendar/packages/core/main.js'></script>
    <script src='/cd/fullcalendar/packages/interaction/main.js'></script>
    <script src='/cd/fullcalendar/packages/daygrid/main.js'></script>
    <script src="/cd/js/main.js"></script>
    <script src="/cd/js/calendar.js"></script>
...
<link rel="stylesheet" href="<c:url value='/c/css/style.css'/>">      
   <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="/cd/css/bootstrap.min.css">   
    <!-- Style -->
