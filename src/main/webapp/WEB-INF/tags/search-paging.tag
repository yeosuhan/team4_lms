...
if(nowPageBlock>1) {
	...
	out.print("<a class=\"page-link\" href=\"" + contextPath + boardType + "/"+(startPage-1) + "?keyword=" + keyword + "\" aria-label=\"Previous\">");
	out.print("◀</a>");
	out.println("</li>");
}
for(int i=startPage; i<=endPage; i++) {
	...
	out.print("<a class=\"page-link bg-warning text-dark\" href=\"" + contextPath + boardType + "/"+(i) + "?keyword=" + keyword  + "\">");
	out.print(i);
	out.print("</a>");		
	out.println("</li>");
} 
if(nowPageBlock<totalPageBlock) {
	out.print("<li class=\"page-item\">");
	out.print("<a  class=\"page-link\" href=\"" + contextPath + boardType + "/"+(endPage+1) + "?keyword=" + keyword  + "\" aria-label=\"Next\">");
	out.print("▶</a>");
	out.println("</li>");
}
out.println("</ul>");
